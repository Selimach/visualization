...
The objectif is to plot on a map some features of the city of Geneva including bike paths and alos main train station. This visualisation can be complemented by other information if available, such as road traffic during the day.
