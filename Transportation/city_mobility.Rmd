...
It is interesting to note that mobiltiy in Paris seems to have resumed to (almost) pre-covid, while in other cities (e.g. Copenhagen), it is not yet the case.
